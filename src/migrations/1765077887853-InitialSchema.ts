...
export class InitialSchema1765077887853 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_active_trips_currentStep"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7634a43cfe76a71c2ed0bc304d" ON "locations" ("isVerified") `);
        await queryRunner.query(`CREATE INDEX "IDX_f2da743fd650de3dacaf61c5b9" ON "locations" ("isActive") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."routes_transportmodes_enum" AS ENUM('bus', 'taxi', 'keke', 'okada', 'walk')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_95dcf730b388a8ff1e907f3d37" ON "routes" ("startLocationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_98d9bf4833e6c587ead0785139" ON "routes" ("endLocationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a9feca2f5b320ff690be3f73b4" ON "routes" ("isVerified") `);
        await queryRunner.query(`CREATE INDEX "IDX_c0434734687fbfe6f12ba78106" ON "routes" ("isActive") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2a3abe7e7c2eb3ba16c1c49866" ON "user_devices" ("deviceType") `);
        await queryRunner.query(`CREATE INDEX "IDX_c0dfeaa96fbe5cde00c32b9c84" ON "user_devices" ("platform") `);
        await queryRunner.query(`CREATE INDEX "IDX_ca2bf740d3888209f78c7e3537" ON "user_devices" ("lastActiveAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_92817ee69d620c10dc53387ccb" ON "user_devices" ("isActive") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_0dd3ffaae26bb6a75ba4d28d93" ON "user_devices" ("userId", "deviceFingerprint") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d535c53a68028a7c3d04ea893d" ON "user_otps" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_69bba5df607a47a57e50f7d9fb" ON "user_otps" ("otpCode") `);
        await queryRunner.query(`CREATE INDEX "IDX_4a6fa59fe04f09c5c5078ed484" ON "user_otps" ("otpType") `);
        await queryRunner.query(`CREATE INDEX "IDX_684a5c918f09eb2073455cf220" ON "user_otps" ("expiresAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_d688e8d33f3f2085cc2c28413f" ON "user_otps" ("isUsed") `);
        await queryRunner.query(`CREATE INDEX "IDX_72d2ebe89377bc0da2bf048ff7" ON "user_otps" ("createdAt") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8f76931fd55913110512ed6e84" ON "users" ("isTestAccount") `);
        await queryRunner.query(`CREATE INDEX "IDX_c0f30dcc205fa03b0d77e95118" ON "users" ("lastLoginAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_8243b68ae56c2f11f7bcd019c8" ON "users" ("reputationScore") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."route_steps_transportmode_enum" AS ENUM('bus', 'taxi', 'keke', 'okada', 'walk')`);
        await queryRunner.query(`ALTER TABLE "route_steps" ADD "transportMode" "public"."route_steps_transportmode_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "trip_logs" ALTER COLUMN "transportModesUsed" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "community_posts" ALTER COLUMN "images" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_d311b6d400f300f6efc987068b" ON "route_steps" ("routeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7043fd1cb64ec3f5ebdb878966" ON "user_badges" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_bd34ef334baea6f589a53438a1" ON "user_badges" ("badgeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_093c33d8cd5f79d74078aee099" ON "active_trips" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a007372b5368469134500a7918" ON "active_trips" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_3ba0cf411157ec6472c4032b4b" ON "reputation_transactions" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fcf2984c5a11575707d9b02f39" ON "reputation_transactions" ("action") `);
        await queryRunner.query(`CREATE INDEX "IDX_98abf367b12f0ea540d8e4a783" ON "reputation_transactions" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_90db14c3cb360d71d7ddd468e0" ON "fare_rules" ("city") `);
        await queryRunner.query(`CREATE INDEX "IDX_8b706ae8d2c870cd14dc99cc9f" ON "fare_rules" ("effectiveFrom") `);
        await queryRunner.query(`CREATE INDEX "IDX_2f1243a59c7fe22f61a16fc4ee" ON "fare_rules" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_0a73281a6725ff879e3e7cc6c8" ON "fare_histories" ("routeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_155fda6804daad39b87c4acd03" ON "fare_histories" ("effectiveDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_43392fbf66087bbdbecabf610e" ON "fare_feedbacks" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_5eb77f567bcdb1d7e50873328b" ON "fare_feedbacks" ("routeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_17e259b108722fe5ff40c380c9" ON "fare_feedbacks" ("isVerified") `);
        await queryRunner.query(`CREATE INDEX "IDX_91f6242adb30a3ac83e1cf3a6d" ON "fare_feedbacks" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_80ab5cefbdfa3bd942c4f7ebf5" ON "direction_shares" ("createdBy") `);
        await queryRunner.query(`CREATE INDEX "IDX_3c49544c366e49118f48557dbf" ON "direction_shares" ("shareToken") `);
        await queryRunner.query(`CREATE INDEX "IDX_722e288728d774d642d7b73d4f" ON "direction_shares" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_db8c73f84984b117f86af97b52" ON "safety_reports" ("reportedBy") `);
        await queryRunner.query(`CREATE INDEX "IDX_143e39d5df44d93a323bd5fdf6" ON "safety_reports" ("locationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4387c65efc85358d8af8832d38" ON "safety_reports" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_3a2640fade228643f526c8ad73" ON "user_interactions" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7274fbb7b10815d07e261c7234" ON "user_interactions" ("interactionType") `);
        await queryRunner.query(`CREATE INDEX "IDX_d02e3c6e2934a732ced260a8ac" ON "user_interactions" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_8c823ac135c1cdfe48a79854fa" ON "search_logs" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_03387e5e075745ccaf0fc72ad7" ON "search_logs" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_2d86d26b570d7df300d102b952" ON "admin_sessions" ("adminId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9412db96e8933fd0c58fdbf0b2" ON "admin_sessions" ("token") `);
        await queryRunner.query(`CREATE INDEX "IDX_c223f198a206026efbc3fa7819" ON "admin_sessions" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_e5ec624f8c8fc830772e8e5e09" ON "trip_logs" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_28b62f92c2b3e45605cf664658" ON "trip_logs" ("tripStartedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_7c9e434b072122306431dc28d9" ON "community_posts" ("authorId") `);
        await queryRunner.query(`CREATE INDEX "IDX_1e740bb86d702700649f417560" ON "community_posts" ("postType") `);
        await queryRunner.query(`CREATE INDEX "IDX_fd7194d38f95159591348a0981" ON "community_posts" ("locationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_152003369320748f77429415ad" ON "community_posts" ("isVerified") `);
        await queryRunner.query(`CREATE INDEX "IDX_3810291c27563f98e02dfe3f21" ON "community_posts" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_7cccc2a761433aac31ea0bfeeb" ON "community_posts" ("createdAt") `);
        ...
        await queryRunner.query(`ALTER TABLE "routes" ADD CONSTRAINT "FK_95dcf730b388a8ff1e907f3d377" FOREIGN KEY ("startLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "routes" ADD CONSTRAINT "FK_98d9bf4833e6c587ead0785139a" FOREIGN KEY ("endLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "route_steps" ADD CONSTRAINT "FK_d311b6d400f300f6efc987068b5" FOREIGN KEY ("routeId") REFERENCES "routes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "route_steps" ADD CONSTRAINT "FK_e1495c28954edf8a72db4ff4f93" FOREIGN KEY ("fromLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "route_steps" ADD CONSTRAINT "FK_ab64e5b333fa59653e898fa4e5c" FOREIGN KEY ("toLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "admins" ADD CONSTRAINT "FK_d220ab96c22e88a1aeb02ec6058" FOREIGN KEY ("createdBy") REFERENCES "admins"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_badges" ADD CONSTRAINT "FK_7043fd1cb64ec3f5ebdb878966c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_badges" ADD CONSTRAINT "FK_bd34ef334baea6f589a53438a1e" FOREIGN KEY ("badgeId") REFERENCES "badges"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_093c33d8cd5f79d74078aee0995" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_d33dd7b6905cba13eec04e03625" FOREIGN KEY ("routeId") REFERENCES "routes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_069fe28b0248a883d0c246b7291" FOREIGN KEY ("currentStepId") REFERENCES "route_steps"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_ec45ca2f8d8e23dcf567abcfad9" FOREIGN KEY ("startLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_03e17250adc95640afbb92faa6e" FOREIGN KEY ("endLocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reputation_transactions" ADD CONSTRAINT "FK_3ba0cf411157ec6472c4032b4b5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "landmarks" ADD CONSTRAINT "FK_56d08593a30d4ad158cf165a6dc" FOREIGN KEY ("locationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "admin_sessions" ADD CONSTRAINT "FK_2d86d26b570d7df300d102b952e" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "landmarks" DROP CONSTRAINT "FK_56d08593a30d4ad158cf165a6dc"`);
        await queryRunner.query(`ALTER TABLE "location_shares" DROP CONSTRAINT "FK_7c78036b9fc4ff08477e5b9c61a"`);
        await queryRunner.query(`ALTER TABLE "reputation_transactions" DROP CONSTRAINT "FK_3ba0cf411157ec6472c4032b4b5"`);
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_03e17250adc95640afbb92faa6e"`);
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_ec45ca2f8d8e23dcf567abcfad9"`);
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_069fe28b0248a883d0c246b7291"`);
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_d33dd7b6905cba13eec04e03625"`);
        await queryRunner.query(`ALTER TABLE "active_trips" DROP CONSTRAINT "FK_093c33d8cd5f79d74078aee0995"`);
        ...
        await queryRunner.query(`ALTER TABLE "admins" DROP CONSTRAINT "FK_d220ab96c22e88a1aeb02ec6058"`);
        ...
        await queryRunner.query(`ALTER TABLE "route_steps" DROP CONSTRAINT "FK_ab64e5b333fa59653e898fa4e5c"`);
        await queryRunner.query(`ALTER TABLE "route_steps" DROP CONSTRAINT "FK_e1495c28954edf8a72db4ff4f93"`);
        await queryRunner.query(`ALTER TABLE "route_steps" DROP CONSTRAINT "FK_d311b6d400f300f6efc987068b5"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP CONSTRAINT "FK_98d9bf4833e6c587ead0785139a"`);
        await queryRunner.query(`ALTER TABLE "routes" DROP CONSTRAINT "FK_95dcf730b388a8ff1e907f3d377"`);
        ...
        await queryRunner.query(`ALTER TABLE "trip_logs" ALTER COLUMN "transportModesUsed" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "active_trips" ADD CONSTRAINT "FK_active_trips_currentStep" FOREIGN KEY ("currentStepId") REFERENCES "route_steps"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_badges" ADD CONSTRAINT "FK_user_badges_badge" FOREIGN KEY ("badgeId") REFERENCES "badges"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
