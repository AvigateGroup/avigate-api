...
export class InitialSchema1763301185994 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create location_shares enum types and table
        ...
        // Add new columns to users table with conditional checks
        await queryRunner.query(`
            DO $$ 
            BEGIN
                IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                               WHERE table_name='users' AND column_name='country') THEN
                    ALTER TABLE "users" ADD "country" character varying NOT NULL DEFAULT 'Nigeria';
                END IF;
            END $$;
        `);
        ...
        await queryRunner.query(`
            ...
            BEGIN
                IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                    ...
                    ALTER TABLE "users" ADD "language" character varying NOT NULL DEFAULT 'English';
                END IF;
            END $$;
        `);

        // Create and add authProvider enum
        await queryRunner.query(`
            DO $$ 
            BEGIN
                IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'users_authprovider_enum') THEN
        ...
        await queryRunner.query(`
            ...
            BEGIN
                IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                               WHERE table_name='users' AND column_name='authProvider') THEN
        ...
        await queryRunner.query(`
            ...
            BEGIN
                IF EXISTS (SELECT 1 FROM information_schema.columns 
                          WHERE table_name='users' AND column_name='phoneNumberCaptured') THEN
                    ALTER TABLE "users" ALTER COLUMN "phoneNumberCaptured" SET NOT NULL;
                END IF;
            END $$;
        `);
        ...
        await queryRunner.query(`
            ...
            BEGIN
                IF EXISTS (SELECT 1 FROM information_schema.columns 
                          WHERE table_name='route_steps' AND column_name='estimatedDuration') THEN
                    ALTER TABLE "route_steps" ALTER COLUMN "estimatedDuration" DROP DEFAULT;
                END IF;
            END $$;
        `);
        
        // Create new indexes on users table
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."users_authprovider_enum"`);
        ...
        // Drop route_segments_mapping table
