...
const TEMPLATE_IDS = {
    ADMIN_INVITATION:
        process.env.SENDGRID_ADMIN_INVITATION_TEMPLATE ||
        'd-1234567890abcdef1234567890abcdef',
    PASSWORD_RESET:
        process.env.SENDGRID_PASSWORD_RESET_TEMPLATE ||
        'd-abcdef1234567890abcdef1234567890',
    ACCOUNT_LOCKED:
        process.env.SENDGRID_ACCOUNT_LOCKED_TEMPLATE ||
        'd-fedcba0987654321fedcba0987654321',
    SECURITY_ALERT:
        process.env.SENDGRID_SECURITY_ALERT_TEMPLATE ||
        'd-456789abcdef0123456789abcdef0123',
    TOTP_ENABLED:
        process.env.SENDGRID_TOTP_ENABLED_TEMPLATE ||
        'd-789abcdef0123456789abcdef01234567',
}
...
class EmailService {
    ...
    getSecurityActionRequired(alertType) {
        const actions = {
            suspicious_login:
                'Please verify this was you. If not, change your password immediately.',
            new_ip_login:
                'If this login was not from you, please secure your account.',
            multiple_failed_attempts:
                'Your account may be under attack. Consider enabling 2FA.',
            unusual_activity: 'Please review your recent account activity.',
            permission_escalation:
                'This is a critical security event. Contact support immediately.',
        }
