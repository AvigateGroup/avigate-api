                ...
                errors: [
                    {
                        field: 'coordinates',
                        message:
                            'Latitude must be between 4.0-14.0 and longitude between 2.5-15.0',
            ...
            errors: [
                {
                    field: 'phoneNumber',
                    message:
                        'Phone number must be a valid Nigerian number (e.g., +2348012345678)',
                    value: phoneNumber,
                },
            ],
        })
...
const validateFareRange = (req, res, next) => {
    ...
    if (estimatedFareMin && estimatedFareMax) {
        if (
            !customValidators.isValidFareRange(
                estimatedFareMin,
                estimatedFareMax
            )
        ) {
            ...
            errors: [
                {
                    field: 'shareCode',
                    message:
                        'Share code must be 8 characters long and contain only letters and numbers',
                    value: shareCode,
                },
            ],
        })
...
const validationMiddleware = {
    ...
    validateUpdateRoute: [validate(routeValidators.update), validateFareRange],
