...
module.exports = (sequelize, DataTypes) => {
  const User = sequelize.define('User', {
    ...
    preferredLanguage: {
      type: DataTypes.ENUM('English', 'Hausa', 'Igbo', 'Yoruba', 'Pidgin'),
  ...
  User.getTopContributors = function(limit = 10) {
    return User.findAll({
      where: { isActive: true },
      order: [['reputationScore', 'DESC'], ['totalContributions', 'DESC']],
      limit,
      attributes: ['id', 'firstName', 'lastName', 'reputationScore', 'totalContributions', 'createdAt']
    });
  };
