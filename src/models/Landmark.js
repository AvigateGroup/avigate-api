module.exports = (sequelize, DataTypes) => {
                ...
                validate: {
                    isValidOperatingHours(value) {
                        if (value && typeof value !== 'object') {
                            throw new Error(
                                'Operating hours must be a valid object'
                            )
                        }
                    },
                },
            ...
            contactInfo: {
                ...
                validate: {
                    isValidContactInfo(value) {
                        if (value && typeof value !== 'object') {
                            throw new Error(
                                'Contact info must be a valid object'
                            )
                        }
                    },
                },
        ...
        },
        {
            ...
            hooks: {
                ...
                beforeUpdate: (landmark) => {
                    ...
                    if (
                        landmark.changed('approvalStatus') &&
                        landmark.approvalStatus === 'approved'
                    ) {
    ...
    Landmark.prototype.getDistance = function (lat, lng) {
        ...
        const a =
            ...
            Math.cos(this.degToRad(this.latitude)) *
            ...
            attributes: [
                ...
                [
                    sequelize.fn(
                        'COUNT',
                        sequelize.literal(
                            'CASE WHEN "approvalStatus" = \'approved\' THEN 1 END'
                        )
                    ),
                    'approvedLandmarks',
                ],
                [
                    sequelize.fn(
                        'COUNT',
                        sequelize.literal(
                            'CASE WHEN "approvalStatus" = \'pending\' THEN 1 END'
                        )
                    ),
                    'pendingLandmarks',
                ],
                [
                    sequelize.fn('AVG', sequelize.col('averageRating')),
                    'avgRating',
                ],
                [
                    sequelize.fn('SUM', sequelize.col('searchCount')),
                    'totalSearches',
                ],
            ],
            raw: true,
