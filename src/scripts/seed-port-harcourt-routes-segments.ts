...
const chobaToRumuokoroLandmarks = [
  ...
  { name: 'Energy Technology Institute University of Port Harcourt', lat: 4.885818, lng: 6.929464 },
...
const rumuokoroToEliozuLandmarks = [
  ...
  { name: 'Dunamis international Gospel center Eloizu,Port harcourt', lat: 4.861162, lng: 7.020798 },
...
const rumuokoroToMile1Landmarks = [
  ...
  { name: 'GNLD PRODUCTS AND NEOLIFE - Vitamin & supplements store', lat: 4.863797, lng: 6.995693 },
